...
namespace Flight_Simulator
{
    public partial class Form1 : Form
    {
        ...
        private void btnStep3Start_Click(object sender, EventArgs e)
        {
            ...
            int tempExpId = expID;
            lblShowDescribe.Text = "intervalFigure";
            ...
            frameRate = int.Parse(tbFrameRate.Text);

            bool ifFirstInterval = true;
            ...
            while (!ifStop)
            {
                ...
                if (newStart - start >= 1000/frameRate)
                {
                    ...
                    if (isExpModule)
                    {
                        ...
                        torqueData[tempExpId].Add(troque_trans);
                        ...
                        if (count == (int)(UsedSequenceTime[expID - 1] * frameRate))
                        {
                            count = 0;
                    ...
                    if (isInterModule & cbCheckVideo.Checked)
                    {
                        ...
                        intervalTorqueData[expID].Add(troque_trans);
                        ...
                        if (count == (int)(UsedSequenceTime[expID-1] * frameRate))
                        {
                            ...
                            torqueData.Add(tempExpId, new List<float>());
                            isExpModule = true;
                            isInterModule = false;
                            ifStartPlayInterval = true;
                        ...
                        //if (count == (int)(interVideoTime * frameRate))
                        //{
                        //    count = 0;
                    ...
                    if (isInterModule & cbCheckCloseLoop.Checked)
                    {
                        ...
                        {
                            IntervalDuration = double.Parse(tbDuration.Text);
                        }

                        if (count == (int)(IntervalDuration * frameRate))
                        {
                            count = 0;
        ...
        private void btnFrameRateSetting_Click(object sender, EventArgs e)
        {
            frameRate = int.Parse(this.tbFrameRate.Text);
